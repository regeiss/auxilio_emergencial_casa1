...
import 'package:gtk_flutter/env/env.dart';
import 'package:gtk_flutter/source/core/network/service/cancel_token_ref.dart';
import 'package:gtk_flutter/source/core/network/service/dio_provider.dart';
import 'package:gtk_flutter/source/features/movies/domain/tmdb_movie.dart';
import 'package:gtk_flutter/source/features/movies/domain/tmdb_movies_response.dart';
...
class MoviesRepository {
  ...
  final Dio client;
  final String apiKey; // = '21ece6709d269c9e2b178c1e599f0f17';

  Future<TMDBMoviesResponse> searchMovies({required MoviesQueryData queryData, CancelToken? cancelToken}) async {
    final uri = Uri(
      scheme: 'https',
  ...
  Future<TMDBMoviesResponse> nowPlayingMovies({required int page, CancelToken? cancelToken}) async {
    final uri = Uri(
      scheme: 'https',
      host: 'api.themoviedb.org',
...
Future<TMDBMovie> movie(
  ...
  return ref.watch(moviesRepositoryProvider).movie(movieId: movieId, cancelToken: cancelToken);
}

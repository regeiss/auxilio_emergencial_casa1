...
import 'package:gtk_flutter/source/features/movies/data/movies_repository.dart';
import 'package:gtk_flutter/source/features/movies/presentation/movies/movie_list_tile.dart';
import 'package:gtk_flutter/source/features/movies/presentation/movies/movie_list_tile_shimmer.dart';
import 'package:gtk_flutter/source/features/movies/presentation/movies/movies_search_bar.dart';
import 'package:gtk_flutter/source/features/movies/presentation/movies/movies_search_query_notifier.dart';
                ...
                ElevatedButton(
                  onPressed: isLoading
                      ...
                      : () {
                          ...
                          ref.invalidate(fetchMoviesProvider(queryData: (page: page, query: query)));
                          // wait until the page is loaded again
                          return ref.read(
                            fetchMoviesProvider(queryData: (page: page, query: query)).future,
                          );
                        },
